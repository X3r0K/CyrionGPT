...
/**
 * Slice content to a maximum number of tokens
 */
const sliceByTokens = (content: string, maxTokens: number): string => {
...
/**
 * Truncate content to 4096 tokens (default for agent)
 */
const truncateContent = (content: string): string => {
  return truncateContentByTokens(content, 4096);
};
